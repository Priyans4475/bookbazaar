  ...
  return (
    <div className='flex justify-center items-center h-screen'>
      ...
      <div className='relative '>
            <div className=' bg-black text-white w-[1000px] h-63 opacity-80 '>
...
<h1 className='p-3'>All the Publishers, Distributors and Authors around the country are welcome to partner with us and grow the Bookbazaar family. We would like to thank our customers for shopping with us. You can write to us on our e-mail id to share any suggestions or feedback you might have regarding our website or services.</h1>
            </div>
      </div>
