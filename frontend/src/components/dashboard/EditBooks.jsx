...
const EditBooks = () => {
  ...
  const {bookTitle,authorName,imageURL,description,bookpdfURL,category} = useLoaderData();
...
"Business",
"Financial"]
const [categorys,setcategory]=useState(categories[0])
...
return (
  <div className='px-4 my-12'>
        ...
        <h1 className='mb-8 text-3xl font-bold'>Update the Book details</h1>
  <form className="flex lg:w-[1180px] flex-col flex-wrap gap-4" onSubmit={handlesubmit}>
     ...
     <textarea type="text" 
      ...
      //  onChange={handleChange}
       name="description" cols="40" rows="5" className='border-2 border-teal-400 rounded-md px-4 py-2 w-full '
