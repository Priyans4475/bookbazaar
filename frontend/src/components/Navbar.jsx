...
const Navbar = () => {
  ...
  return (
   <header className='w-full bg-transparent fixed top-0 left-0 right-0 transition-all ease-in duration-300 z-index:2'>
     <nav  className={`py-4 lg:px-24 z-1 px-4 ${issticky ? "sticky top-0 left-0 right-0 bg-blue-300 " :""}`}>
