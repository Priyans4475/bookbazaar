...
const Navbar = () => {
  ...
  const navItems =[
    ...
    {link:'Home',path:'/'},
    {link:'Explore',path:'/shop'},
    {link:'Books',path:'/authorsbooks'},
...
<nav className={`py-4 lg:px-24 px-4 ${issticky ? "sticky top-0 left-0 right-0 bg-black text-white opacity-80 z-999" : "z-1"}`}>
